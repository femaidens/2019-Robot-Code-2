...
public class Lift extends Subsystem {
  public static CANSparkMax frontLeft = new CANSparkMax(6, MotorType.kBrushless);//RobotMap.frontPort, MotorType.kBrushless);//3
  public static CANSparkMax rearLeft = new CANSparkMax(12, MotorType.kBrushless);//RobotMap.rearPort, MotorType.kBrushless);//15
...
public Lift(){
  ...
  */
  ...
  public static void liftTeleop(){
     double rightSpeed = OI.atkJoy1.getRawAxis(5);
